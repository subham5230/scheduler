...
export default function Home() {
  ...
  return (
    <div className="container h-screen flex justify-center items-center overflow-hidden">
      <div className="lg:w-[70%] lg:h-[80%] flex">
        <div className="lg:w-1/2">
          <h1 className="text-6xl h-[20%] flex items-end font-brand font-semibold tracking-wide">
            Subham Mohanty
          </h1>
          <div className="flex h-[80%] justify-between">
            <div className=" flex-1 max-w-[75%] flex flex-col justify-center">
              ...
              <p className="text-lg mt-2 mb-1 text-[#d8d8d8]">
              ...
              <button
                ...
                className="ctaButton text-white w-[75%] font-semibold text-lg h-[3rem] transition-all ease-linear duration-50"
              >
                SCHEDULE A MEET
              </button>
            </div>
            <div className="w-[3rem] flex items-end relative">
